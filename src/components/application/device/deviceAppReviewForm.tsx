...
interface IDeviceAppReviewProps {
  formValues: IFormValuesDevices;
}

function DeviceAppReviewForm({ formValues }: IDeviceAppReviewProps) {
  return (
    <div>
      <div className="my-2 rounded-md shadow-xl">
        ...
        <div className="px-10">
          ...
          <div className="grid grid-cols-2">
            ...
            <ShowKeyValue
              name={"Device Brand"}
              value={formValues?.applicationData?.deviceBrand}
            />
            <ShowKeyValue
              name={"Device Model"}
              value={formValues?.applicationData?.deviceModel}
            />
            <ShowKeyValue
              name={"Device Color"}
              value={formValues?.applicationData?.deviceModelColor}
            />
            <ShowKeyValue
              name={"Device Price"}
              value={formValues?.applicationData?.devicePrice}
            />
            <ShowKeyValue
              name={"Device Unique Number"}
              value={formValues?.applicationData?.deviceUniqueNumber}
            />
          </div>
        </div>
      </div>
...
export default DeviceAppReviewForm;
