...
export async function creditLifePdfkit(reqData: any, packageData: any) {
  ...
  const pdfBuffer = await new Promise<string>((resolve) => {
    ...
    doc
      .font("Helvetica")
      .fontSize(12)
      .text("Telkom Motor Credit Life Plan", 20, 30);
    ...
    //     field == "said"
    //       ? "SAID"
    //       : field == "telkomFreeBenefitAmount"
    //       ? "Telkom Free Cover Amount"
    ...
    doc
      ...
      .text(
        `VIN Number: ${
          reqData?.policyData?.creditLife?.vinNumber
            ? reqData?.policyData?.creditLife?.vinNumber
            : ""
        }`,
        30,
    ...
    doc
      ...
      .fontSize(8)
      .text(
        reqData?.policyData?.creditLife?.freeCoverPremium,
        (doc.page.width * 3) / 4,
        100
      );
    doc
    ...
    doc
      ...
      .fontSize(8)
      .text(
        reqData?.policyData?.creditLife?.sumAssured,
        doc.page.width / 2,
        120
      );
    doc
      ...
      .fontSize(8)
      .text(
        reqData?.policyData?.creditLife?.additionalPremium,
        (doc.page.width * 3) / 4,
        120
      );
    doc
    ...
    doc
      ...
      .fontSize(8)
      .text(
        reqData?.policyData?.creditLife?.totalPremium,
        (doc.page.width * 3) / 4,
        140
      );
